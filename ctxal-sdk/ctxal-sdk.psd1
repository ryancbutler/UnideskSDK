...
FunctionsToExport = 'add-alappassignment', 'add-alelappassignment', 'connect-alsession', 
               ...
               'get-alconnector', 'Get-ALDirectory', 'get-alDirectoryDetail', 
               ...
               'get-aluserDetail', 'get-aluserlist', 'Get-ALVMName', 
               'Import-allayerrev', 'Import-aloslayer', 'invoke-allayerfinalize', 
               'Invoke-ALPublish', 'new-alapplayer', 'new-alapplayerrev', 
               'new-aldirectory', 'new-alicon', 'new-alImage', 'New-ALOsLayerRev', 
               'New-ALPlatformLayer', 'New-ALPlatformLayerRev', 
               'remove-alappassignment', 'remove-alapplayerrev', 
               'remove-aldirectory', 'remove-alelappassignment', 'remove-alicon', 
               'Remove-ALImage', 'remove-aloslayerrev', 'remove-alplatformlayerrev', 
               'set-alapplayer', 'set-aldirectory', 'set-alImage', 'stop-alworkticket', 
